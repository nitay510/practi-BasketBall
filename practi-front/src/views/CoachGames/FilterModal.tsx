...
const FilterModal: React.FC<FilterModalProps> = ({ teams, selectedTeams: initialSelectedTeams, startDate: initialStartDate, endDate: initialEndDate, isOpen, onClose, onApplyFilters }) => {
