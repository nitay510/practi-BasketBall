...
export const PrivacyPage=():  JSX.Element => {
  return (
    <div className='privacy'>
      ...
      <p>ההסכמה לשימוש שלנו בעוגיות בהתאם לתנאים של מדיניות זו בזמן הביקור באתר שלנו, מאפשרת לנו להשתמש בעוגיות בכל פעם שאתם מבקרים באתר.</p>
      <h2>ב. קרדיט</h2>
      <p>המסמך הזה נוצר בעזרת תבנית של SEQ Legal (seqlegal.com) ושונתה על ידי Website Planet (www.websiteplanet.com)</p>
      <h2>ג. איסוף </h2>
      <p>  יקודד ולא יעשה בו כל שימוש  אין חובה להכניס אף פרט , וניתן להשתמש בפרטים בדויים</p>
      <p></p>
<h2>ד.שימוש בפרטים האישיים שלכם</h2>
<p>הבפרטים  שנמסרו לנו דרך האתר שלנו ייעשה שימוש למטרות שצוינו במדיניות זו, או בעמודים הרלוונטיים שבאתר. ייתכן שנשתמש ב למטרות הבאות:
...
<p>
אנחנו עשויים למסור את הפרטים שלכם:
לפי מה שנדרש מאתנו על פי חוק;</p>
בהקשר של כל הליך משפטי קיים או עתידי;
למעט על פי הכתוב במדיניות זו, אנו לא נספק את הפרטים שלכם לצד ג’.<p/>
<h2>ו.אבטחת הפרטים  שלכם</h2>
<p>אנחנו ננקוט משנה זהירות ארגוני וטכני סביר על מנת למנוע את האבדן, השימוש לרעה, או השינוי של הפרטים  שלכם.
אנחנו נאחסן את כל הפרטים  שאתם מספקים בשרתים מאובטחים (המוגנים בסיסמא ובחומת אש).
