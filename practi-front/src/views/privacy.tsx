...
export const PrivacyPage=():  JSX.Element => {
  return (
    <div className='privacy'>
      ...
      <p>מידע על המחשב שלכם, כולל כתובת ה-IP שלכם, מיקומכם הגאוגרפי, סוג הדפדפן והגרסה שלו, ומערכת ההפעלה;
...
כל סוג אחר של פרטים אישיים שאתם שולחים אלינו</p>
...
<p>אנחנו עשויים למסור את הפרטים האישיים שלכם לכל אחד מהעובדים, המנהלים, המבטחים, היועצים המקצועיים, הסוכנים, הספקים, או קבלני המשנה שלנו, במידה סבירה וכנדרש למטרות המצוינות במדיניות זו.
