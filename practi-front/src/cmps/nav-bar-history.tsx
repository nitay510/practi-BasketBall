...
interface NavBarHistoryProps {
  category: string;
  setCategory: (topic: string) => void;
}

/* this component is the bar where you choose category of videos */
export const NavBarHistory = ({category,setCategory }: NavBarHistoryProps): JSX.Element => {
  ...
  const [startIndex, setStartIndex] = useState(categories.indexOf(category));
